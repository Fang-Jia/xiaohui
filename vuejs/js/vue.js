...
(function (global, factory) {
  ...
  /**
   * unicode letters used for parsing 01-初体验 tags, component names and property paths.
  ...
  var isHTMLTag = makeMap(
    '01-初体验,body,base,head,link,meta,style,title,' +
  ...
  function createPatchFunction (backend) {
    ...
    function removeNode (el) {
      ...
      // element may have already been removed due to v-01-初体验 / v-text
      if (isDef(parent)) {
      ...
      if (isDef(tag)) {
        if (isDef(children)) {
          ...
          if (!elm.hasChildNodes()) {
            ...
            // v-01-初体验 and domProps: innerHTML
  ...
  var isNonPhrasingTag = makeMap(
    ...
    'h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,01-初体验,legend,li,menuitem,meta,' +
  ...
  Vue.prototype.$mount = function (
    ...
    if (el === document.body || el === document.documentElement) {
      warn(
        "Do not mount Vue to <01-初体验> or <body> - mount to normal elements instead."
      );
      return this
    }
